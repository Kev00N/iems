                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @foreach($demerits as $demerit)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">{{ $merit->prisoner->name }}</td> 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center items-center space-x-2">
                                        ...
                                        <form action="{{ route('demerits.destroy', $demerit->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this demerit?')">
                                            @csrf
                                            @method('DELETE')
